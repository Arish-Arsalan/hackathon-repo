...
import ShoppingCart from '@/app/component/cart';
function Header() {
        ...
        <header>
            <div className="flex justify-between items-center mx-auto max-w-screen-2xl p-4">
                ...
                <div className="flex gap-3 md:space-x-12 md:mr-32 items-center ">
                    <Link href='/myaccount'>
                        <FaRegUser aria-label="User Profile" size={19} />
                    </Link>
                    <FiSearch aria-label="Search" size={19} />
                    <IoMdHeartEmpty aria-label="Favorites" size={19} />
