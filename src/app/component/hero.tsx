...
function Hero({ products }: any) {
  return (
    <div className="bg-[#fbebb5]  mx-auto  max-w-screen-2xl">
      ...
      <div className="relative md:w-[1600px] md:h-[450px] h-full flex items-center justify-center w-full">
        <div className="absolute -left-[10%] inset-0 flex flex-col items-center justify-center text-black">
